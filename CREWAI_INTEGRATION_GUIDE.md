...
**A step-by-step guide to stress-test your existing CrewAI agents with SentinelAI**
...
### Step 3: Wrap Your Crew with SentinelAI
...
```python
from sentinelai.injectors.tool_failure import ToolFailureInjector, ToolFailureConfig, FailureMode
...
from sentinelai.injectors.delay import DelayConfig, DelayPattern
...
### Problem: "ModuleNotFoundError: No module named 'sentinelai'"
...
```bash
pip install --upgrade sentinelai
```
...
- 💬 Ask questions in [GitHub Issues](https://github.com/arielshad/sentinel-ai/issues)
- 🐛 Report bugs in [GitHub Issues](https://github.com/arielshad/sentinel-ai/issues)
