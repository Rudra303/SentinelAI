...
1. **Email**: Send details to rudraofficial303@gmail.com with the subject line "SECURITY: [Brief Description]"
2. **GitHub Security Advisory**: Use the [private vulnerability reporting feature](https://github.com/Rudra303/SentinelAI/security/advisories/new)
...
For general security questions or concerns, feel free to open a public discussion in [GitHub Discussions](https://github.com/Rudra303/SentinelAI/discussions) or reach out via email.
